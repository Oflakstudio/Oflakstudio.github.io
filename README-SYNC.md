...
- choose **which images/videos** appear in a project (the `media` list) and the **thumbnail**;
...
Want it to update automatically while you work? Run this in a terminal and leave it open:

```bash
node sync.js --watch
```

Each time you drop a file into an asset folder, it re-syncs within a second.
